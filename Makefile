.PHONY: all clean deep-clean base claude-code openai-codex open-code pi
...
all: base claude-code openai-codex open-code pi
...
clean:
	...
	@for image in pi open-code claude-code openai-codex agent-base; do \
